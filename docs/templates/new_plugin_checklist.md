...
| Analysis (QUS method) | New file: `quantus/analysis/paramap/analysis_methods/<name>.py` (or `bmode/analysis_methods/`) | Function `<name>(scan_rf_window, phantom_rf_window, window, config, image_data, **kwargs) -> None`, writes results onto `window`; decorated with `@output_vars(...)` at minimum | [quantus/analysis/README.md](../../quantus/analysis/README.md) |
